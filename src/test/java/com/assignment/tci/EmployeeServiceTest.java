...
//        List<BonusEligibleEmployees.CurrencyGroup> result = employeeService.getBonusEligibleEmployees(requestedDate);
//
//        // Sort the results for consistent order
//        result.sort(Comparator.comparing(BonusEligibleEmployees.CurrencyGroup::getCurrency));
//
//        // Debugging: print employee names
//        for (BonusEligibleEmployees.CurrencyGroup currencyGroup : result) {
...
//
//        BonusEligibleEmployees.CurrencyGroup inrGroup = result.get(0);
//        BonusEligibleEmployees.CurrencyGroup usdGroup = result.get(1);
//
